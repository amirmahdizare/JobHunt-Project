...
const Jh_QuickCareerTips = () => {
    const classes = useClasses()
    return (
        <Box className={classes.root} width="100%">
            <Container className={classes.container} maxWidth="lg" >
                <Box mt={5} textAlign="center">
                    <Typography variant="h4">Quick Career Tips</Typography>
                    <Typography  color="textSecondary">Found by employers communicate directly with hiring managers and recruiters.</Typography>
                </Box>
